    ...
    <ul class="nav">
      ...
      <li class="nav-item {{ ($activePage == 'profile' || $activePage == 'user-management') ? ' active' : '' }}">
        <a class="nav-link " data-toggle="collapse" href="#laravelExample1" aria-expanded="false">
          <i><img style="width:25px" src="{{ asset('img/admin_general.png') }}"></i>
      ...
      <li class="nav-item {{ ($activePage == 'profile' || $activePage == 'user-management') ? ' active' : '' }}">
        <a class="nav-link" data-toggle="collapse" href="#laravelExample2" aria-expanded="false">
          <i><img style="width:25px" src="{{ asset('img/mantenimiento.png') }}"></i>
          <p>{{ __('Mantenimiento') }}
            <b class="caret"></b>
          </p>
        </a>
      ...
      <li class="nav-item {{ ($activePage == 'profile' || $activePage == 'user-management') ? ' active' : '' }}">
        <a class="nav-link" data-toggle="collapse" href="#laravelExample4" aria-expanded="true">
          <i><img style="width:25px" src="{{ asset('img/general.png') }}"></i>
          <p>{{ __('Adm. General') }}
            <b class="caret"></b>
          </p>
        </a>
